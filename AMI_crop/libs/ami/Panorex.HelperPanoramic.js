...
class HelpersPanoramic extends HelpersMaterialMixin(THREE.Object3D) {
  ...
  _create() {
    ...
    if (!this._material) {
      ...
      // correction to have always last panorex in the nearest position
      this._uniforms.nOp.value = this._options.nOp;

      this._geometry.computeBoundingBox();
      var bb = this._geometry.boundingBox;
      this._uniforms.uMaxY.value = bb.max.y;  // always on top of panorex geometry
