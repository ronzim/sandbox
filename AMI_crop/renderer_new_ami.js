...
initializeData = function(_files) {
  ...
  .then(function() {
    ...
    // DEV __________________________________________
    // find spline center
    ...
    console.log(points);
    r2.stackHelper = panorex.generateCrossSections(0.5, points, plane, stack, splineCenter);
    ...
    console.log(splineCenter);
    r3.stackHelper = panorex.generateCrossSections(0.5, points, plane, stack, splineCenter);
    ...
    gui.add(cs,'s', 0, 1).step(0.01).onChange(function (v){
      ...
      var newPlaneGeom = panorex.createCSGeometry(csPlane, pos, stack, plane);
      // newPlaneGeom.computeBoundingBox();
      // console.log('center',newPlaneGeom.boundingBox.getCenter());
