...
var ShadersUniform       = require("./Panorex.ShaderDataUniform.js").ShadersUniform;
var ShadersVertex        = require("./Panorex.ShaderDataVertex.js").ShadersVertex;
...
class HelpersPanoramic extends HelpersMaterialMixin(THREE.Object3D) {
  constructor(stack,
    ...
    this._canvasWidth = options.canvasWidth; //DEV
    this._options = options; //DEV
  ...
  _create(geometry) {
    ...
    if (!this._material) {
      ...
      // for cycle doesn't work

      this._uniforms.uP0.value = [this._options.tenPoints[0].x, this._options.tenPoints[0].y, this._options.sCoords[0]];
      this._uniforms.uP1.value = [this._options.tenPoints[1].x, this._options.tenPoints[1].y, this._options.sCoords[1]];
      this._uniforms.uP2.value = [this._options.tenPoints[2].x, this._options.tenPoints[2].y, this._options.sCoords[2]];
      this._uniforms.uP3.value = [this._options.tenPoints[3].x, this._options.tenPoints[3].y, this._options.sCoords[3]];
      this._uniforms.uP4.value = [this._options.tenPoints[4].x, this._options.tenPoints[4].y, this._options.sCoords[4]];
      this._uniforms.uP5.value = [this._options.tenPoints[5].x, this._options.tenPoints[5].y, this._options.sCoords[5]];
      this._uniforms.uP6.value = [this._options.tenPoints[6].x, this._options.tenPoints[6].y, this._options.sCoords[6]];
      this._uniforms.uP7.value = [this._options.tenPoints[7].x, this._options.tenPoints[7].y, this._options.sCoords[7]];
      this._uniforms.uP8.value = [this._options.tenPoints[8].x, this._options.tenPoints[8].y, this._options.sCoords[8]];
      this._uniforms.uP9.value = [this._options.tenPoints[9].x, this._options.tenPoints[9].y, this._options.sCoords[9]];

      this._geometry.computeBoundingBox();
      var bb = this._geometry.boundingBox;
      this._uniforms.uMaxY.value = bb.min.y;  // always on nearest vertex of panorex geometry
  ...
  updateShaderProps(options) {
    ...
    this._geometry.computeBoundingBox();
    var bb = this._geometry.boundingBox;
    this._uniforms.uMaxY.value = bb.min.y;  // always on top of panorex geometry
  }
