...
var HelpersPanoramic   = require("./CS.HelperPanoramic.js").HelpersPanoramic;

class HelpersStack extends THREE.Object3D {
  constructor(stack,geom,panoCenter) {  //DEV
    //
    super();
  ...
  _prepareSlice() {
    ...
    // DEV
    console.log(this._panoCenter)
    this._slice = new HelpersPanoramic(this._stack, this._geometry, this._panoCenter, this._index, position, direction);
    // END DEV
