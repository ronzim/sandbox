...
var HelpersPanoramic   = require("./Mc.HelperPanoramic.js").HelpersPanoramic;

class HelpersStack extends THREE.Object3D {
  constructor(stack,geometry) {
    //
    super();
  ...
  _prepareSlice() {
    ...
    this._slice = new HelpersPanoramic(this._stack, this._geometry, this._index, position, direction);
